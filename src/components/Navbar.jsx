        ...
        <Fragment>
            <nav className="navbar navbar-expand-lg">
                <div className="container">
                    <Link className="navbar-brand fw-bold " to="/">React with Props drilling - Context API Example</Link>
                    <div className="d-flex">
                        <Link className="nav-link " to="/props-dril/parent">Parent-Props-drilling</Link>
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link className="nav-link " to="/context-api/parent">Parent-context-api</Link>
